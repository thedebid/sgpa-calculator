...
<head>
    ...
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <meta name="keywords"
        content="Semester Grade Point Calculator, SGPA Calculator, Pokhara University, Calclate SGPA, Convert GPA, Calculate SGPA, How to Convert SGPA, Sgpa Pokhara University, GPA Pokhara University, Pokhara University GPA, SGPA system" />
    <!-- //for-mobile-apps -->
    <!-- font-awesome icons -->
        ...
        <div class="profile">
            <div class="wrap">
                    ...
                    <div class="content-left">
                        <div class="content-info">
                                    ...
                                    <ul class="rslides callbacks callbacks1" id="slider4">
                                        <li>
                                            <div class="w3layouts-banner-info">
                                                ...
                                                <p>This SGPA calculator is specially designed according to grading
                                                    system of Pokhara University (PU), Nepal.</p>
                                            </div>
                                        </li>
                                        <li>
                                            <div class="w3layouts-banner-info">
                                                <h3>Pokhara University</h3>
                                                <p>To Calculate SGPA, you must know the credits of each subject. The
                                                    credits are usually mentioned on the syllabus.</p>
                                            </div>
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <div class="agileinfo-social-grids">
                                <ul>
                                    <a href="https://facebook.com/linkwithDM" target="_blank"><i
                                            class="fa fa-facebook"></i></a>
                                    <a href="https://instagram.com/thedebid"><i class="fa fa-instagram"></i></a>
                                    <a href="https://twitter.com/thedebid"><i class="fa fa-twitter"></i></a>
                                    <a href="https://linkedin.com/thedebid#"><i class="fa fa-linkedin"
                ...
                <div class="wthree_footer_copy">
                    <p>© 2018 SGPA Calculator. All rights reserved | Developed by <a href="http://davidmagar.com.np/"
                            target="_blank">David Magar</a></p>
                </div>
            </div>
        </div>
    </div>
